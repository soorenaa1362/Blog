        ...
        <div class="row">
            <div class="col-md-12 mb-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.articles.update', ['article'=>$article->id]) }}" 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select name="active" class="form-control">
                                        <option value="0" <?php if($article->active == 0) echo 'selected' ?> >
                                            منتشر نشده
                                        </option>
                                        <option value="1" <?php if($article->active == 1) echo 'selected' ?> >
                                            منتشر شده
                                        </option>
                                    </select>
                                </div>
